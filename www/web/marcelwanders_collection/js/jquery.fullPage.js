    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        FP.reBuild = function(resizing){
            ...
            windowsHeight = $window.height() - 350 ;  //updating global var
        ...
        */
        function prepareDom(){
            ...
            windowsHeight = $window.height() - 350;
        ...
        */
        ...
        function addTableClass(element){
            element.addClass(TABLE).wrapInner('<div class="' + TABLE_CELL + '" style="height:' + getTableHeight(element) + 'px; min-height:450px;" />');
        }
        ...
        */
        function setBodyClass(){
            ...
            $('.slide-nav a.' + slideAnchor).addClass('active');

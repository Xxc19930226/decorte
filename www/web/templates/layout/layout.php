...
<?php include_metas() ?>
<title><?php if (has_slot('title')): ?><?php echo is_array(get_slot('title')) ? implode(' &#124; ', get_slot('title')) : get_slot('title') ?> &#124; <?php endif ?>黛珂中国官方网站</title>
...
<footer class="globalFooter">
    ...
    <nav class="globalFooter__nav">
        <ul>
            <li class="globalFooter__nav__item"><a href="/images/home/footer/yinsi.html" target="_blank">隐私政策</a></li>
            <!--
            <li class="globalFooter__nav__item"><a href="http://www.kose.co.jp/jp/ja/kiyaku/index.html" target="_blank">Terms Of Use</a></li>
          -->
            <li class="globalFooter__nav__item"><a href="http://kose.com.cn/" target="_blank">高丝企业官网</a></li>
        </ul>
    </nav>
    <address class="globalFooter__copyright">
    黛珂在线购买热线：400-920-2203      © 高丝化妆品销售（中国）有限公司版权所有   沪ICP备09002279号-8
    </address>
</footer>

...
<ul class="breadcrumb">
  <li class="breadcrumb__item"><?php echo link_to($product['Line']['name_en'], '/' . $product['Line']['slug'] . '/') ?></li>
...
<article class="itemdetail">
  <div class="left">
    <p class="itemdetail__linelogo">
      ...
      <?php else: ?>
      <?php echo link_to(image_tag($product['Line']['relative_image_path'], array('alt' => $product['Line']['name_en'])), '/' . $product['Line']['slug'] . '/') ?>
      <?php endif ?>
    </p>
    ...
    <p class="itemdetail__bestcosme"><a href="/news/bestcosme2015.html"><img src="/images/bestcosme/logo_best_cosme.png" alt="ベストコスメ受賞"></a></p>
    <?php endif ?>

...
/**
 * ProductSearchLog filter form base class.
 *
 ...
 */
abstract class BaseProductSearchLogFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sub_category' => new sfWidgetFormFilterInput(),
      'effect'       => new sfWidgetFormFilterInput(),
      'sort'         => new sfWidgetFormFilterInput(),
      'hit'          => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'valid_flag'   => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'sub_category' => new sfValidatorPass(array('required' => false)),
      'effect'       => new sfValidatorPass(array('required' => false)),
      'sort'         => new sfValidatorPass(array('required' => false)),
      'hit'          => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'valid_flag'   => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'created_at'   => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 00:00:00')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 23:59:59')))),
      'updated_at'   => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 00:00:00')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 23:59:59')))),
    ));

    $this->widgetSchema->setNameFormat('product_search_log_filters[%s]');

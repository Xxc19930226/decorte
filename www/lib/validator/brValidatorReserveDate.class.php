...
class brValidatorReserveDate extends sfValidatorSchema {
    ...
    protected function doClean($values) {
        ...
        if ($this->getOption('required') && $number1_value == 0 && $number2_value == '---') {
            $error = new sfValidatorError($this, 'required', array());
        } elseif ($number1_value != 0 || $number2_value != '---') {
            if ($number1_value != 0 && $number2_value != '---') {
            } else { 

...
/**
 * brValidatorSchemaCompare compares several values from an array.
 *
 * @package    symfony
 * @subpackage validator
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @version    SVN: $Id: sfValidatorSchemaCompare.class.php 12 2011-05-12 03:42:19Z oda $
 */
class brValidatorSchemaCompare extends sfValidatorSchema
{
  const EQUAL              = '==';
  const NOT_EQUAL          = '!=';
  const IDENTICAL          = '===';
  ...
  protected function doClean($values)
  {
    ...
    // 2011/06/27 namekawa add 
    if (!$values[$this->getOption('left_field')]) {
        return $values; 
    } 

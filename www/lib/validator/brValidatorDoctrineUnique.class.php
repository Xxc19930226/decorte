...
class brValidatorDoctrineUnique extends sfValidatorSchema
{
  /**
   * Constructor.
   *
  ...
  protected function doClean($values)
  {
    ...
    if ($except) {
        ...
        foreach ($except as $except_key => $except_value) {
            $q->addWhere($except_key . ' != ?', $except_value);
        }
    }

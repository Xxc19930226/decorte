...
/**
 * ProductSearchLog form base class.
 *
 * @method ProductSearchLog getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseProductSearchLogForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sub_category' => new sfWidgetFormInputText(),
      'effect'       => new sfWidgetFormInputText(),
      'sort'         => new sfWidgetFormInputText(),
      'hit'          => new sfWidgetFormInputText(),
      'valid_flag'   => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'sub_category' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'effect'       => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'sort'         => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      'hit'          => new sfValidatorInteger(),
      'valid_flag'   => new sfValidatorBoolean(),
      'created_at'   => new sfValidatorDateTime(),
      'updated_at'   => new sfValidatorDateTime(),
    ));

    $this->widgetSchema->setNameFormat('product_search_log[%s]');

...
/**
 * ProductFavorite form base class.
 *
 * @method ProductFavorite getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseProductFavoriteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('product_favorite[%s]');

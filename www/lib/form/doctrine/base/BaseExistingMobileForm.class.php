...
/**
 * ExistingMobile form base class.
 *
 * @method ExistingMobile getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseExistingMobileForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('existing_mobile[%s]');

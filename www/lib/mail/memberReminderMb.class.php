...
class memberReminderMb extends btJapaneseMessage {
    public function __construct($mail, $unique, $flag) {
        ...
        $this->setTo($mail);
        $this->setSubject('【COSME DECORTE】ﾊﾟｽﾜｰﾄﾞ変更URLのお知らせ');
        $this->setBody(
            "※このﾒｰﾙは、登録ﾒｰﾙｱﾄﾞﾚｽ宛に自動的に送信されています。\n".
            "\n". 
            "ﾊﾟｽﾜｰﾄﾞを変更されたい場合は、下記のURLにｱｸｾｽしてください。\n".
            "\n".
            $url."\n".
            "\n".
            "※ﾊﾟｽﾜｰﾄﾞ変更はこのﾒｰﾙの送信時刻から".sfConfig::get('app_member_effective_time').
            "時間までとなります。\n".
            "※このﾒｰﾙにお心あたりが無い場合には下記の「■お問い合わせ」までご連絡ください。\n".
            "\n".
            "■お問い合わせ\n".
